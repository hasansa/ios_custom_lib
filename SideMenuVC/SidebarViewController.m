...
- (void)updateSelectedCell:(UITableViewCell *)cell indexPath:(NSIndexPath *)indexPath withDisplayImageKey:(NSString*)key
{
    ...
    [[AppearanceTheme sharedTheme] secondColor]:    // blue bakground color
    [[AppearanceTheme sharedTheme] mainColor];      // white bakground color
...
{
    NSString * cellIdentifier = @"Cell";//([SPLocalization isRTL])? @"RCell" : @"Cell";
    ...
    selectedBackgroundView.backgroundColor = [[AppearanceTheme sharedTheme] secondColor];

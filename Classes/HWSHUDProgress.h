...
typedef NS_ENUM(NSUInteger, HWSUDProgressBackgroundType) {
	/** Don't allow user interactions and show a blurred background. Default value. */
	HWSHUDProgressBackgroundTypeBlurred,
	/** Don't allow user interactions and show a solid color background. */
	HWSHUDProgressBackgroundTypeSolid,
};

/** @see showWithParameters: */
extern NSString * const HWSHUDProgressViewParameterFullScreen;
/** @see showWithParameters: */
extern NSString * const HWSHUDProgressViewParameterBackgroundType;
/** @see showWithParameters: */
extern NSString * const HWSHUDProgressViewParameterStatus;
/** @see showWithParameters: */
extern NSString * const HWSHUDProgressViewParameterSuperview;

/** The minimum time (in seconds) the hud will be displayed. No matter if <code>dismiss</code> is called. */
static NSTimeInterval const HWSHUDMinimumDisplayTime = NSIntegerMax;
/** The minimum time (in seconds) the success will be displayed. */
static NSTimeInterval const HWSHUDMinimumSuccessDisplayTime = 1.0;
/** The minimum time (in seconds) the error will be displayed. */
static NSTimeInterval const HWSHUDMinimumErrorDisplayTime = NSIntegerMax;

@interface HWSHUDProgress : UIView

#pragma mark - Appearance

/** Color of the background view. Is not used when backgroundType is HWSHUDProgressBackgroundTypeBlurred. */
@property (nonatomic) UIColor *backgroundFillColor NS_AVAILABLE_IOS(7_0) UI_APPEARANCE_SELECTOR;
/** Tint color of the background view. Used to tint blurred background only when backgroundType is HWSHUDProgressBackgroundTypeBlurred. */
...
/**
 ...
 <br/><br/>Use:
 <br/><br/><code><b>HWSHUDProgressViewParameterFullScreen</b></code>:<br/> to precise full screen or not HUD (<code>NSNumber</code> value from a boolean). <br/><i>Omit to set default non full screen.</i>
 <br/><br/><code><b>HWSHUDProgressViewParameterBackgroundType</b></code>:<br/> to precise blurred or solid HUD background (<code>NSNumber</code> value from a <code>HWSHUDProgressBackgroundType</code> enumeration value). <br/><i>Omit to set default blurred background type.</i>
 <br/><br/><code><b>HWSHUDProgressViewParameterStatus</b></code>:<br/> to precise the HUD status (<code>NSString</code> value). <br/><i>Omit to set default no status.</i>
 <br/><br/><code><b>HWSHUDProgressViewParameterSuperview</b></code>:<br/> to precise the superview of the HUD. <br/><i>Omit to set default current window superview.</i>
 <br/><br/>Example:
 <br/>
 <pre>
[HWSHUDProgress showWithParameters:<br/>
  @{HWSHUDProgressViewParameterFullScreen: @(YES),<br/>
    HWSHUDProgressViewParameterBackgroundType: @(HWSHUDProgressBackgroundTypeSolid),<br/>
    HWSHUDProgressViewParameterStatus: \@"Loading",<br/>
    HWSHUDProgressViewParameterSuperview: self.view<br/>
   }];
 </pre>
...
/**
 ...
 <br/><br/><b>Remark:</b> You may want to use <code>dismissWithCompletion:</code> if <code>HWSHUDMinimumDisplayTime</code> is greater than zero.
...
/**
 ...
 <br/><br/><b>Remark:</b> This method can be usefull if the <code>HWSHUDMinimumDisplayTime</code> constant is greater than zero to ensure the view is correctly dismissed.

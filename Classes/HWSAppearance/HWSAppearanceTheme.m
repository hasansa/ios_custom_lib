...
@implementation HWSAppearanceTheme

+ (id <HWSAppearanceThemeDelegate>)sharedTheme
{
    static id <HWSAppearanceThemeDelegate> sharedTheme = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedTheme = [[HWSCustomAppearanceTheme alloc] init];
    });
    return sharedTheme;
}
+ (void)customizeAppAppearance
{
    id <HWSAppearanceThemeDelegate> theme = [self sharedTheme];
...
{
    label.textColor = [[HWSAppearanceTheme sharedTheme] mainColor];

...
@interface HWSImagePager () <UIScrollViewDelegate>
{
    __weak id <HWSImagePagerDataSource> _dataSource;
    __weak id <HWSImagePagerDelegate> _delegate;

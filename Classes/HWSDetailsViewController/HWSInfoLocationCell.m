...
@implementation HWSInfoLocationCell

+ (HWSInfoLocationCell*) addressLocationDetailCell
{
    HWSInfoLocationCell * cell = [[[NSBundle mainBundle] loadNibNamed:@"HWSInfoLocationCell" owner:self options:nil] objectAtIndex:0];
